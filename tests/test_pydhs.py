...
class TestPydhs(object):
    ...
    def setup_class(cls):
        pass
        # self.d = Database('db_antonio_india',
        #              'krishnab',
        #              '3kl4vx71',
        #              'localhost',
        #              5432)
    ...
    #
    #
    #     res = self.d.get_dictionary_cursor_query("select column_name from " \
    #                                              "information_schema.columns wheretable_name = 'iabr42fl'")
    #     print(res)
    #     print(type(res))
    ...
    def test_database_get_dictionary_cursor_query(self):
        d = Database('db_antonio_india',
                     ...
                     'localhost',
                     5432)
        res = d.get_dictionary_cursor_query("select column_name from information_schema.columns "
                                            "where table_name = 'iabr42fl'")
        print(res)
        print(type(res))
        assert isinstance(res, list)
        #d.set_connection_closed()
